...
describe('API - Profile', () => {
    ...
    context('todos os perfis', () => {
        ...
        it('valida a API de perfis', () => {
            ...
            cy.request({
                ...
                expect(body[0].skills).to.have.lengthOf(1)      // valida o tamnho o array
                expect(body[0].date).to.not.be.null             // valida que a data não é nula
                expect(headers['x-powered-by']).to.eq('Express')    // valida a informação do header
            })
        })
    })
    ...
    context('perfil específico', () => {         
        ...
        it.only('Valida u usuário válsido buscando na base', () => {
